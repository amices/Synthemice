---
title: "Confidence validity of bootstrap estimates"
author: "Gerko Vink"
date: "7/20/2020"
output: 
  html_document:
...
We use the `replicate()` function to draw `nsim =``r nsim` bootstrap sets from the `origin`
```{r cache=TRUE}
...
# Results
Below are the coverages for each of the investigated scenarios. Results are depicted for the coverage of the confidence intervals over the regression estimates for `r nsim` simulations.
```{r}
