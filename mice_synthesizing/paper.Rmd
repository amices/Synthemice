...
author:
- Thom Volker^[Helpful and stimulating discussions with Stef van Buuren, Hanne Oberman, Paulina von Stackelberg, Mirthe Hendriks and Stijn Overbeek are gratefully acknowledged.] & Gerko Vink
...
$$
with $u^{(l)}$ reflecting the variance estimate in every imputed data set.
