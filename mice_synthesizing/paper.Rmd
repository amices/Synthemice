...
$$
with $u^{(l)}$ reflecting the variance estimate in every imputed dataset.
...
```{r}
## Merely illustrative, single dataset, plot of age
synthetic_samples[[1]] %>% 
...
## Merely illustrative, single dataset, plot of gen
...
## Merely illustrative, single dataset, plot of bmi by region
