...
For example, overimputing the observed and missing values in the `mice::boys` data set into the object `syn`, given the same imputation parameters as before, can be realized by the following code execution
