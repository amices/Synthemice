...
rho[lower.tri(rho)] <- rho[upper.tri(rho)] <- c(.15,.25,.35)
n1 <- 100                   # Sample size
n2 <- 1000
n3 <- 10000
...
# Obtain the results
cor_summary_out_cart_part_n100 <- print_results(cor_out_cart_part_n100, coefs = real_coefs)
cor_summary_out_cart_part_n1000 <- print_results(cor_out_cart_part_n1000, coefs = real_coefs)
cor_summary_out_cart_part_n10000 <- print_results(cor_out_cart_part_n10000, coefs = real_coefs)
...
cor_summary_out_norm_part_n1000 <- print_results(cor_out_norm_part_n1000, coefs = real_coefs)
cor_summary_out_norm_part_n10000 <- print_results(cor_out_norm_part_n10000, coefs = real_coefs)
