...
@. Over `nsim` iterations, the average estimates are calculated ($\bar{Q}$), the bias ($\mu_Q - \bar{Q}$), the confidence intervals averaged over all iterations, and the coverage ($\frac{1}{nsim} \sum_{i = 1}^{nsim} Lower_i < \mu_Q < Upper_i$).
